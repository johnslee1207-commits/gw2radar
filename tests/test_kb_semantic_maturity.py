...
def test_kb_semantic_maturity_report_prioritizes_release_readiness_after_policy_packs() -> None:
    ...
    assert report.recommended_priorities[0].priority_id == "P17"
...
def test_kb_semantic_maturity_api_exports_markdown() -> None:
    ...
    assert response.json()["data"]["report"]["recommended_priorities"][0]["priority_id"] == "P17"
