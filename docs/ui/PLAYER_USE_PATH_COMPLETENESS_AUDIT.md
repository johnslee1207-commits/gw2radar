...
| `support_case_incident_packet` | PASS | mature_support_case_incident_packet | 4 files with checksum df3f99055fc4. | None for MVP depth. |
| `support_case_incident_packet_zip_verification` | PASS | mature_support_case_incident_packet_zip_verification | zip checksum c3016f3e3cd1 verified with 4 files. | None for MVP depth. |
...
| `support_case_incident_operator_packet_zip_verification` | PASS | mature_support_case_incident_operator_packet_zip_verification | operator zip checksum d5175c1761c1 verified with 9 files. | None for MVP depth. |
...
| `support_case_incident_final_handoff_packet_artifacts` | PASS | mature_support_case_incident_final_handoff_packet_artifacts | 6 final handoff files with checksum 2302fb0ca33e. | None for MVP depth. |
| `support_case_incident_final_handoff_packet_zip_verification_audit` | PASS | mature_support_case_incident_final_handoff_packet_zip_verification_audit | final handoff zip checksum 0f2c665a76ac verified with 6 files. | None for MVP depth. |
...
| `support_case_incident_closure_packet_artifacts` | PASS | mature_support_case_incident_closure_packet_artifacts | 7 closure files with checksum f9da072fa2ee. | None for MVP depth. |
| `support_case_incident_closure_packet_zip_verification_audit` | PASS | mature_support_case_incident_closure_packet_zip_verification_audit | closure zip checksum b61b61699df2 verified with 7 files. | None for MVP depth. |
...
| `player_session_packet_artifacts` | PASS | mature_session_packet_artifacts | 4 files with checksum ff71ae0ab065. | None for MVP depth. |
| `player_support_handoff` | PASS | mature_support_handoff | needs_review with 7 next actions. | None for MVP depth. |
| `player_support_handoff_artifacts` | PASS | mature_support_handoff_artifacts | 4 files with checksum 385beaea3863. | None for MVP depth. |
| `player_support_handoff_zip_verification` | PASS | mature_support_handoff_zip_verification | zip checksum 3f77611cddba verified with 4 files. | None for MVP depth. |
...
| `player_support_handoff_final_archive` | PASS | mature_support_handoff_final_archive | 6 files with zip checksum 7e41e023c4df. | None for MVP depth. |
...
| `productized_report_packet_zip_verification_audit` | PASS | mature_productized_report_packet_zip_audit | 3 productized report artifacts bundled with checksum 371af513b954. | None for MVP depth. |
