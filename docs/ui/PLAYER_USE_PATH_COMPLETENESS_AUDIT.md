...
| `support_case_incident_packet` | PASS | mature_support_case_incident_packet | 4 files with checksum ea5a9253f488. | None for MVP depth. |
| `support_case_incident_packet_zip_verification` | PASS | mature_support_case_incident_packet_zip_verification | zip checksum 82d6347b46dd verified with 4 files. | None for MVP depth. |
...
| `support_case_incident_operator_packet_zip_verification` | PASS | mature_support_case_incident_operator_packet_zip_verification | operator zip checksum 9f2983ab2677 verified with 9 files. | None for MVP depth. |
...
| `support_case_incident_final_handoff_packet_artifacts` | PASS | mature_support_case_incident_final_handoff_packet_artifacts | 6 final handoff files with checksum 82c54bf608c7. | None for MVP depth. |
| `support_case_incident_final_handoff_packet_zip_verification_audit` | PASS | mature_support_case_incident_final_handoff_packet_zip_verification_audit | final handoff zip checksum 9324e08b85f6 verified with 6 files. | None for MVP depth. |
...
| `support_case_incident_closure_packet_artifacts` | PASS | mature_support_case_incident_closure_packet_artifacts | 7 closure files with checksum 1c8076ccda8c. | None for MVP depth. |
| `support_case_incident_closure_packet_zip_verification_audit` | PASS | mature_support_case_incident_closure_packet_zip_verification_audit | closure zip checksum 783d288a5751 verified with 7 files. | None for MVP depth. |
...
| `player_session_packet_artifacts` | PASS | mature_session_packet_artifacts | 4 files with checksum d897a818f283. | None for MVP depth. |
| `player_support_handoff` | PASS | mature_support_handoff | needs_review with 7 next actions. | None for MVP depth. |
| `player_support_handoff_artifacts` | PASS | mature_support_handoff_artifacts | 4 files with checksum 8b1ae2547ef8. | None for MVP depth. |
| `player_support_handoff_zip_verification` | PASS | mature_support_handoff_zip_verification | zip checksum 999fd397518e verified with 4 files. | None for MVP depth. |
...
| `player_support_handoff_final_archive` | PASS | mature_support_handoff_final_archive | 6 files with zip checksum e14c8869193d. | None for MVP depth. |
...
| `productized_report_packet_zip_verification_audit` | PASS | mature_productized_report_packet_zip_audit | 3 productized report artifacts bundled with checksum 136f4fdbdfea. | None for MVP depth. |
