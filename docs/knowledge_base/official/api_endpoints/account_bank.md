---
title: GW2 API endpoint /v2/account/bank
domain: official
content_type: source_note
summary: Initial endpoint summary for /v2/account/bank; verify behavior against the source PDF before promotion to reviewed.
source_refs:
linked_entities: api_endpoint:/v2/account/bank
linked_actions: INGEST_SOURCE, VALIDATE_API_SCOPE
confidence: 0.9
review_status: draft
---

# GW2 API Endpoint /v2/account/bank
...
- primary_entities: `api_endpoint:/v2/account/bank`
...
- source_pdf: `docs/knowledge_base/_sources/pdf/official_api/endpoints/API_2_account_bank - Guild Wars 2 Wiki (GW2W).pdf`
- evidence_id: `evidence:pdf:api_endpoint:account_bank`
