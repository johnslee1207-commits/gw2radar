---
title: GW2 API endpoint /v2/characters
domain: official
content_type: source_note
summary: Initial endpoint summary for /v2/characters; verify behavior against the source PDF before promotion to reviewed.
source_refs:
linked_entities: api_endpoint:/v2/characters
linked_actions: INGEST_SOURCE, VALIDATE_API_SCOPE
confidence: 0.9
review_status: draft
---

# GW2 API Endpoint /v2/characters
...
- primary_entities: `api_endpoint:/v2/characters`
...
- source_pdf: `docs/knowledge_base/_sources/pdf/official_api/endpoints/API_2_characters - Guild Wars 2 Wiki (GW2W).pdf`
- evidence_id: `evidence:pdf:api_endpoint:characters`
