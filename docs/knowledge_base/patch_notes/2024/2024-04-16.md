---
title: GW2 Patch Note 2024-04-16
domain: official
content_type: summary
summary: Structured draft summary for the official GW2 patch note dated 2024-04-16; impact fields require manual review before use in recommendations.
source_refs:
...
# GW2 Patch Note 2024-04-16

- patch_id: `patch:2024-04-16`
- date: `2024-04-16`
- source_pdf: `docs/knowledge_base/_sources/pdf/patch_notes/2024/Game Update Notes_ April 16, 2024 - Game Update Notes - Guild Wars 2 Forums.pdf`
- evidence_id: `evidence:pdf:patch:2024-04-16`
- confidence: `0.65`
- review_status: `draft`
