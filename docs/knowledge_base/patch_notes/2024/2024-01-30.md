---
title: GW2 Patch Note 2024-01-30
domain: official
content_type: summary
summary: Structured draft summary for the official GW2 patch note dated 2024-01-30; impact fields require manual review before use in recommendations.
source_refs:
...
# GW2 Patch Note 2024-01-30

- patch_id: `patch:2024-01-30`
- date: `2024-01-30`
- source_pdf: `docs/knowledge_base/_sources/pdf/patch_notes/2024/Game Update Notes_ January 30, 2024 - Game Update Notes - Guild Wars 2 Forums.pdf`
- evidence_id: `evidence:pdf:patch:2024-01-30`
- confidence: `0.65`
- review_status: `draft`
