...
summary: Structured draft summary for the official GW2 patch note dated 2026-06-02; impact fields require manual review before use in recommendations.
source_refs:
...
- date: `2026-06-02`
- source_pdf: `docs/knowledge_base/_sources/pdf/patch_notes/2026/Game Update Notes_ June 2, 2026 - Game Update Notes - Guild Wars 2 Forums.pdf`
